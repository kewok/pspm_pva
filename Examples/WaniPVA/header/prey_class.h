...
class prey
	...
	public:
		...
		void update_prey_density_dependence();
		void update_prey_growth_noise();
...
struct update_density_dependence
{
	/* 
                Elements in the tuple.
                ----------------------
                0: prey density dependence (prey d.d)
                1: prey d.d change
        */
        template <typename tuple>
        __host__ __device__
